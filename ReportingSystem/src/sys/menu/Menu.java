...
public class Menu extends JComponent {
    ...
    private String[][] menuItems = new String[][]{
        {"Dashboard"},
        {"Citizen Records", "Add Record", "Update Record", "Search Record"},
        {"Verification", "New Verification Request", "View Verification History", "Print Verification Report"},
        {"Users", "Add User", "Manage User Accounts"},
        {"Activity Logs"},
        {"Settings"}
    };
    ...
    private Icon getIcon(int index) {
        String[] iconNames = {
            "dashboard", "records", "verification", "users", "logs", "settings"
        };
